...
export default function Page() {
  return (
    <div
      className="h-screen max-h-screen w-full overflow-hidden text-[var(--text-main)]"
      style={{ backgroundColor: "var(--bg-main)" }}
    >
      {/* h-screen + flex + space-between: Hero | Middle | Final — zero scroll */}
      <main className="mx-auto flex h-full min-h-0 w-full max-w-[720px] flex-col justify-between gap-0 px-4 py-1.5 text-[clamp(9.5px,1.45vmin,11.75px)] leading-[1.2] text-[#a49794] sm:px-5">
        {/* TOP — Hero */}
        ...
        {/* MIDDLE — Core + mechanics + investor (compressed, flex-1 fills gap) */}
        <div className="flex min-h-0 flex-1 flex-col justify-center overflow-hidden py-0.5">
          <div className="min-h-0 w-full overflow-hidden">
            {/* CORE MESSAGE */}
            <section className="border-t border-[#6a4444]/28 pt-1 text-left leading-[1.2]">
            ...
            {/* SCAM MECHANICS */}
            <section className="mt-1 border-t border-[#6a4444]/28 pt-1 text-center leading-[1.2]">
            ...
            {/* INVESTOR */}
            <section className="mt-1 border-t border-[#6a4444]/28 pt-1 text-left leading-[1.2] opacity-[0.88]">
        ...
        {/* BOTTOM — Final */}
        <section className="shrink-0 border-t border-[#6a4444]/28 pt-1.5 text-center leading-[1.18]">
