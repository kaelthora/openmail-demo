...
export default function Page() {
  return (
    <div className="h-screen w-full overflow-hidden bg-[radial-gradient(circle_at_15%_10%,rgba(176,112,112,0.045)_0%,rgba(10,10,10,0)_35%),radial-gradient(circle_at_82%_4%,rgba(176,112,112,0.03)_0%,rgba(10,10,10,0)_38%),#0a0a0a] text-[var(--text-main)]">
      {/* HERO */}
      <main className="mx-auto flex h-full w-full max-w-5xl flex-col justify-center px-6 py-4">
        <section className="text-center">
          ...
          <Link
            href="/openmail"
            prefetch={false}
            className="mt-4 inline-block rounded-lg border border-[#c79a9a]/30 bg-[#b88888] px-5 py-2 text-sm font-medium text-[#120f0f] no-underline transition hover:scale-105 hover:bg-[#c09595]"
          >
        ...
        <section className="mt-4 border-t border-[#8b5f5f]/30 pt-4 text-left text-sm text-[#b5aba8] md:text-base">
          ...
          <p className="text-[#c79595]">→ Decision: BLOCKED</p>
        </section>

        {/* THREAT */}
        <section className="mt-5 border-t border-[#8b5f5f]/30 pt-4 text-left">
        ...
        {/* IMPACT */}
        <section className="mt-4 border-t border-[#8b5f5f]/30 pt-4 text-center">
        ...
        {/* FUNCTION */}
        <section className="mt-4 border-t border-[#8b5f5f]/30 pt-4 text-center text-sm text-[#a49794] md:text-base">
