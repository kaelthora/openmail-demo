...
Alex`,
  ...
  {
    id: "demo-newsletter-digest",
    folder: "inbox",
    title: "Digest Co.",
    sender: "news@digest-co.example",
    subject: "Your weekly digest — no reply needed",
    preview:
      "Top stories from the week. No action required — manage preferences anytime.",
    content: `Hello,

Here is your weekly roundup. No reply is needed.

— Digest Co.`,
    aiPreview: "Low-touch newsletter",
    confidence: 90,
    needsReply: false,
    deleted: false,
    read: false,
    ...
    x: 40,
    y: 40,
    rfc822MessageId: "<demo-newsletter-digest@openmail.demo>",
    syncedAi: {
      risk: "safe",
      summary: "Newsletter — no response expected",
      reason: null,
      action: "ignore",
      suggestions: [
